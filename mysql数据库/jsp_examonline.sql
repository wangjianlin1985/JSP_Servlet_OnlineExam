...
Source Database       : jsp_examonline

Target Server Type    : MYSQL
Target Server Version : 50505
File Encoding         : 65001

Date: 2020-01-29 14:16:49
*/
...
CREATE TABLE `paper` (
  `id` int(2) DEFAULT NULL COMMENT '试卷号',
  `time` int(10) DEFAULT NULL COMMENT '考试时间',
  ...
  `quantity` int(3) DEFAULT NULL COMMENT '总题目数量'
...
CREATE TABLE `question` (
  `number` varchar(8) COLLATE utf8_unicode_ci NOT NULL COMMENT '题目序号',
  ...
  `select` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '题目选项',
  `score` float NOT NULL COMMENT '题目分值',
  `key` varchar(50) COLLATE utf8_unicode_ci NOT NULL COMMENT '题目答案/关键词',
  `img` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '题目配图',
...
CREATE TABLE `score` (
  `ID` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '学生号',
  `score` float DEFAULT -1 COMMENT '总分数',
  `score_sing` float DEFAULT -1 COMMENT '单选题分数',
  `score_muti` float DEFAULT -1 COMMENT '多选题分数',
  `score_jud` float DEFAULT -1 COMMENT '判断题分数',
  `score_fill` float DEFAULT -1 COMMENT '填空题分数',
  `score_ess` float DEFAULT -1 COMMENT '简答题分数',
  `grade` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '成绩评价',
...
-- Records of score
-- ----------------------------
INSERT INTO `score` VALUES ('1001', '98', '16', '20', '20', '12', '30', '优秀');
...
INSERT INTO `score` VALUES ('1009', '21', '9', '0', '12', '0', '0', '不及格');
...
CREATE TABLE `student` (
  `ID` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '学生号',
  `password` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '学生密码',
  `name` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '学生姓名',
  `class` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '学生班级',
...
-- Records of student
-- ----------------------------
INSERT INTO `student` VALUES ('1001', '123456', '赵安军', '计科164', '98');
...
INSERT INTO `student` VALUES ('1009', '0000', '李建国', '计科164', '21');
...
CREATE TABLE `teacher` (
  `ID` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '教职工号',
  `password` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '教师密码',
  `name` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '教师姓名',
  `class` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '教师班级',
  `job` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '教师职称',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
